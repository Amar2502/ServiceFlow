  ...
  if (!user || !allowedRoles.includes(user.role)) {
    return (
      <div className="flex-1 space-y-5 p-4 md:p-8">
        <div className="rounded-lg border border-red-300 dark:border-red-900 bg-red-50 dark:bg-red-950/30 p-6 text-red-950 dark:text-red-200 shadow-sm space-y-4">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-300">
